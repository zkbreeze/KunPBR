...
public:
    ...
    // kvs::ValueArray<float> toPressureArray( float fraction );
    // kvs::ValueArray<float> toDensityArray( float fraction );
    // kvs::ValueArray<float> toTemperatureArray( float fraction );
