...
//
//
//  Created by Kun Zhao on 2014-09-11 14:58:22.
//
//

#ifndef KUN__CELLBYCELLPARTICLEGENERATOR_H_INCLUDE
#define KUN__CELLBYCELLPARTICLEGENERATOR_H_INCLUDE
    ...
    const bool isKunSamplingStep = false )
{
    ...
    const float sampling_volume_inverse = 1.0f / ( subpixel_length * subpixel_length * current_sampling_step );
...
#endif // KUN__CELLBYCELLPARTICLEGENERATOR_H_INCLUDE